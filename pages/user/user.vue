<template>
	<view class="container" style="transition: all 1s ease; opacity: 0" :style="show ? 'transition: all .5s ease; opacity: 1' : ''">
		<uni-card v-if="userinfo" padding="0">
			<uni-collapse>
				<uni-collapse-item :open="show" titleBorder="none">
					...
					<button @longpress="onLongPress" @chooseavatar="onChooseAvatar" open-type="chooseAvatar" hover-class="hover" class="edit-avatar">
					...
					<uni-list-item :clickable="userinfo.type == 1" :showArrow="userinfo.type == 1" @click="edit('班级', userinfo.class)" title="班级">
						<template v-slot:footer>
					...
					<view style="padding: 10px">
						<uni-forms ref="form1" :modelValue="formData" label-width="80px">
							...
							<uni-forms-item label="新密码" required name="newpwd">
								<uni-easyinput trim="both" v-model="formData.newpwd" type="password" placeholder="请输入新密码" />
							</uni-forms-item>
							<uni-forms-item label="确认密码" required name="newpwd2">
								<uni-easyinput trim="both" v-model="formData.newpwd2" type="password" placeholder="请确认新密码" />
							</uni-forms-item>
						</uni-forms>
					...
					<view style="padding: 10px">
						<uni-forms ref="addStudentForm" :modelValue="addUserFormData" label-width="80px">
							<uni-forms-item label="学号/id" name="id">
								<uni-easyinput trim="both" v-model="addUserFormData.id" placeholder="输入学号/id（留空自动生成id）" />
							</uni-forms-item>
